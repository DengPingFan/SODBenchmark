...
[It][1998][PAMI] A Model of Saliency-Based Visual Attention for Rapid Scene Analysis,
[FG][2003][ACMMM]Contrast-based image attention analysis by using fuzzy growing,
...
[RE][2006][ICME]Region enhanced scale-invariant saliency detection,
[SR]  [2007][CVPR]Saliency Detection A Spectral Residual Approach,
[GB][2007][NIPS]Graph-Based Visual Saliency,
[RU][2007][TMM]A rule based technique for extraction of visual attention regions based on real-time clustering,
[SUN][2008][JOV]SUN: A bayesian framework for saliency using natural statistics,
[AC][2008][ICVS]Salient region detection and segmentation,
[FT][2009][CVPR]Frequency-tuned Salient Region Detection,
[ICC][2009][ICCV]Image saliency by isocentric curvedness and color,
[EDS][2009][PR]simple method for detecting salient regions,
...
[CSM][2010][ACMMM]Automatic interesting object extraction from images using complementary saliency maps,
[HC,RC][2011][CVPR]Global Contrast based Salient Region Detection,
[SVO][2011][ICCV]Fusing generic objectness and visual saliency for salient object detection,
[CSD][2011][ICCV]Center-surround divergence of feature statistics for salient object detection,
[CC][2011][ICCV]Salient object detection using concavity context,
...
[GS][2012][ECCV]Geodesic saliency using background priors,
[BSF][2012][ICIP]Saliency Detection Based on Integration of Boundary and Soft-Segmentation,
[GC,GU][2013][ICCV]Efficient Salient Region Detection with Soft Image Abstraction,
...
[DRFI][2013][CVPR]Salient Object Detection A Discriminative Regional Feature Integration Approach,
[DSR][2013][ICCV]Saliency Detection via Dense and Sparse Reconstruction,
[PISA][2013][CVPR]Pisa: Pixelwise image saliency by aggregating complementary appearance contrast measures with spatial priors,
...
[STD][2013][CVPR]Statistical textural distinctiveness for salient region detection in natural images,
[CRF][2013][CVPR]Saliency Aggregation A Data-driven Approach,
[SUB][2013][CVPR]Submodular salient region detection,
[UFO][2013][ICCV]Salient Region Detection by UFO Uniqueness, Focusness and Objectness,
[CHM][2013][ICCV]Contextual hypergraph modeling for salient object detection,
[COV][2013][JOV]Visual saliency estimation by nonlinearly integrating features using region covariances,
[CIO][2013][ICCV]Category-independent object-level saliency detection,
[GR][2013][SPL]Graph-Regularized Saliency Detection With Convex-Hull-Based Center Prior,
[SLMR][2013][BMVC]Segmentation driven lowrank matrix recovery for saliency detection,
[LSSC][2013][TIP]Bayesian Saliency via Low and Mid Level Cues,
[LSMD][2013][AAAI]Salient object detection via low-rank and structured sparse matrix decomposition,
[HDCT][2014][CVPR]Salient Region Detection via High-Dimensional Color Transform,
[PDE][2014][CVPR]Adaptive partial differential equation learning for visual saliency detection,
...
[MAPM][2015][TIP]Saliency Region Detection based on Markov Absorption Probabilities,
[NCS][2015][TIP]Normalized cut-based saliency detection by adaptive multi-level region merging,
[BFS][2015][NC]Saliency Detection via Background and Foreground Seed Selection,
[UF][2016][TMM]A Universal Framework for Salient Object Detection,
[MST][2016][CVPR]Real-Time Salient Object Detection with a Minimum Spanning Tree,
[PM][2016][ECCV]【post-processing method】Pattern Mining Saliency,
[DSP][2016][PR]Discriminative saliency propagation with sink points,
[EBM][2016][IJCAI]Saliency Transfer An Example-Based Method for Salient Object Detection,
[AWC][2016][Neurocomputing]Robust manifold-preserving diffusion-based saliency detection by adaptive weight construction,
[MRMF][2016][TNNLS] Manifold Ranking-Based Matrix Factorization for Saliency Detection,
[SBCRF][2017][Neurocomputing]A superpixel-based CRF saliency detection approach,
...
[MDC][2017][TIP]300-FPS Salient Object Detection via Minimum Directional Contrast,[code]
[SS][2017][NC]Spectral Salient Object Detection,
[IFC][2017][TMM]Iterative Feedback Control Based Salient Object Segmentation,
[CCRF][2017][TMM]Saliency Detection by Fully Learning A Continuous Conditional Random Field,
[ELER][2017][CVPR]What is and what is not a salient object? learning salient object detector by ensembling linear exemplar regressors,
[DIMD][2017][PR]Diversity Induced Matrix Decomposition Model for salient object detection,
[ProS][2018][NC]ProS]Salient Object Detection via Proposal Selection,
...
[JLSE][2018][TIP] Exemplar-aided Salient Object Detection via Joint Latent Space Embedding,
[WFD][2018][PR]Water flow driven salient object detection at 180 fps,
[FBQ][2018][Access]Hypergraph Optimization for Salient Region Detection Based on Foreground and Background Queries,
[FTOE][2019][TMM]Salient Object Detection via Fuzzy Theory and Object-level Enhancement,
[KSR][2019][TIP]Visual Saliency Detection via Kernelized Subspace Ranking with Active Learning, (SOC)
[FCB][2019][TIP]Exploiting Color Volume and Color Difference for Salient Region Detection,
[TSG][2019][TCSVT]Salient Object Detection Via Two-Stage Graphs,
[DSC][2019][TCSVT]Direction Selective Contour Detection for Salient,
[AIGC][2019][TCSVT]Adaptive Irregular Graph Construction Based Salient Object Detection,
[PDP][2019][TIP]RGB-‘D’ Saliency Detection With Pseudo Depth,
[NIO][2019][TNNLS] Semisupervised Learning Based on a Novel Iterative Optimization Model for Saliency Detection,
[MSR][2019][TIP]50 FPS Object-Level Saliency Detection via Maximally Stable Region
[MSGC][2019][TMM]Saliency Detection via Multi-Scale Global Cues,
[LRR][2019][TIP]Local Regression Ranking for Saliency Detection,
